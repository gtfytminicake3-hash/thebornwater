...
echo Running RunAll...
%UNITY_EXE% -projectPath "D:\Tinh\TheBonwater" -batchmode -quit -executeMethod TheBonwater.Rebuild.Editor.RebuildAutoRunner.RunAll -logFile "D:\Tinh\TheBonwater\Logs\unity_recovery_runall.log"
